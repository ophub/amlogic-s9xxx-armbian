...
| -k | Kernel | Specify [kernel](https://cdn.kernel.org/pub/linux/kernel/v5.x/) name, such as `-k 5.10.100`. Multiple kernels use `_` to connect, such as `- k 5.15.25_5.10.100` |
...
| kernel_version | 5.15.25_5.10.100 | Specify [kernel](https://cdn.kernel.org/pub/linux/kernel/v5.x/) name, such as `5.10.100`. Function reference `-k` |
