...
113   Syncthing                                     installed       update/remove
114   FileBrowser                                   installed       update/remove
115   Heimdall                                      not-installed   install
201   Desktop                                       installed       update/remove
202   Firefox                                       installed       update/remove
203   VLC-Media-Player                              installed       update/remove
204   MPV-Media-Player                              installed       update/remove
205   GIMP                                          installed       update/remove
