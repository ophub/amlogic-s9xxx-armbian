...
software_308() {
    ...
    install)
        ...
        if [[ "${VERSION_CODENAME}" == "bookworm" ]]; then
            # Reference documentation: Cooip JM # Update: accordding to https://docs.pxvdi.lierfang.com/pxvdi-source.html
            echo "deb https://download.lierfang.com/pxcloud/pxvdi ${VERSION_CODENAME} main" >/etc/apt/sources.list.d/pveport.list
            curl https://download.lierfang.com/pxcloud/lierfang.gpg -o /etc/apt/trusted.gpg.d/pveport.gpg
