...
software_308() {
    ...
    install)
        ...
        if [[ "${VERSION_CODENAME}" == "bookworm" ]]; then
            # Reference documentation: Cooip JM # Update：https://docs.pxvdi.lierfang.com/pxvdi-source.html
            echo "deb https://download.lierfang.com/pxcloud/pxvdi ${VERSION_CODENAME} port" >/etc/apt/sources.list.d/pveport.list
