...
my $temp_low_high = 50;#硬盘待机时cpu温度小于50度,风扇停转

my $temp_low_low = 38;#硬盘非待机时cpu温度小于38度,风扇停转

# 风扇启动温度低限(摄氏度): 大于于等于此值按启动风扇散热
my $temp_fanOn = 55;

# 风扇启动温度低限(摄氏度):根据硬盘待机与否设置停转温度
my $temp_fanOn_high = 65;#硬盘待机时cpu温度大于65度,风扇启动

my $temp_fanOn_low = 55;#硬盘非待机时cpu温度大于55度,风扇启动
